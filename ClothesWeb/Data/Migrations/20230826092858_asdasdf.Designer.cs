...
namespace ClothesWeb.Data.Migrations
{
    ...
    [Migration("20230826092858_asdasdf")]
    partial class asdasdf
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClothesWeb.Data.Entites.types.Clothing", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("Clothing");
            ...
            modelBuilder.Entity("ClothesWeb.Data.Entites.types.Coats_jackets", b =>
                {
                    b.HasBaseType("ClothesWeb.Data.Entites.types.Clothing");

                    b.Property<int>("Name")
                        .HasColumnType("int");

                    b.HasDiscriminator().HasValue("Coats_jackets");
                });
            ...
            modelBuilder.Entity("ClothesWeb.Data.Entites.types.Pants", b =>
                {
                    ...
                    b.ToTable("Clothing", t =>
                        {
                            t.Property("Name")
                                .HasColumnName("Pants_Name");
                        });
            ...
            modelBuilder.Entity("ClothesWeb.Data.Entites.types.Polo_TShirts", b =>
                {
                    ...
                    b.ToTable("Clothing", t =>
                        {
                            t.Property("Name")
                                .HasColumnName("Polo_TShirts_Name");
                        });

                    b.HasDiscriminator().HasValue("Polo_TShirts");
                });
            ...
            modelBuilder.Entity("ClothesWeb.Data.Entites.types.Suits", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("Suits");
                });
            ...
            modelBuilder.Entity("ClothesWeb.Data.Entites.types.Sweater", b =>
                {
                    ...
                    b.ToTable("Clothing", t =>
                        {
                            t.Property("Name")
                                .HasColumnName("Sweater_Name");
                        });

                    b.HasDiscriminator().HasValue("Sweater");
                });

            modelBuilder.Entity("ClothesWeb.Data.CategoriesModel.Image", b =>
                {
                    b.HasOne("ClothesWeb.Data.Entites.types.Clothing", "Clothes")
                        .WithMany("Images")
